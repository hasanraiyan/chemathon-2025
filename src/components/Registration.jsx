    ...
    <section id="registrations" className="py-20 bg-gray-100 dark:bg-gray-900">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="max-w-4xl mx-auto">
          <a href="https://forms.gle/jxpmH1FBL9BkRGd36" target="_blank" rel="noopener noreferrer" className="bg-blue-600 text-white font-bold py-4 px-8 rounded-lg text-xl hover:bg-blue-900 transition duration-300 inline-block mb-12">
            Register Now
          </a>
